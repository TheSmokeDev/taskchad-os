...
| **Universal Persona Cognition** | Unified lifecycle contract: cognition, reflection/dream, qualification, and recall tuning; verify running version | [universal-persona-cognition](features/universal-persona-cognition.md) | Framework hooks, shared dispatcher, scheduled admission, and Learning tab |
| Persona Learning Loop | Scheduled compatibility entry points and historical reflection architecture | [persona-learning-loop](features/persona-learning-loop.md) | `thehomie profile learning`, reflection/dream admission |
| Autonomous Persona Harness Learning | Understanding, investigations, exact synthesis consumption, reports, and separate tuning policy history | [persona-harness-learning](features/persona-harness-learning.md) | Learning tab, `profile learning lifecycle`, `evolve tune/status/rollback` |
| Persona Harness Learning Developer Guide | Shared journal/queue, provenance, synthesis checkpoints, authority, tuning, and operator API contracts | [persona-harness-learning-developer](features/persona-harness-learning-developer.md) | Durable cognition, qualification, exact input/context receipts, and read-only inspection |
