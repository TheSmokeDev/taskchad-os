# PRP-E03G-discord-adapter: Discord Persona Turn Adapter

**Status:** draft — requires WF2 review and source-specific hardening
**Primary POL anchors:** POL-RT-001, POL-EX-001, POL-EX-002, POL-MG-001
**Depends on:** E03E

## Goal and context
Migrate Discord persona turns to PersonaTurnService while declaring thread/edit/attachment/stream/cancel/delivery support truthfully.
...
- **Discord ingress/egress records preserve channel/thread/message IDs as external references.**
- **Support declaration drives negative fallback tests.**
- **Delivery receipt remains separate from turn execution.**

Stable reasons include: unsupported_feature, delivery_failed, delivery_unknown, domain_unavailable, legacy_path_disabled. Unknown exceptions map to a typed `internal_error` with redacted detail; they do not become success.
