# PRP-E02E-authorized-invocation: Atomic Authorized Capability Invocation

**Status:** draft — requires WF2 review and source-specific hardening
**Primary POL anchors:** POL-CP-004, POL-PA-007, POL-JB-009; invariant 16
**Depends on:** E02A, E02C, E02D

## Goal and context
Normalize/validate input, atomically reauthorize immediately before effects, bind executor authorization, validate output, and persist typed outcome.
...
- **InvocationAuthorization binds descriptor/version, digest, relevant state version, issue/expiry and policy/approval references.**
- **InvocationOutcome separates accepted, started, succeeded, failed and outcome_unknown.**
- **Provider idempotency key is persisted before dispatch.**

Stable reasons include: input_invalid, authorization_stale, authorization_missing, authorization_consumed, output_invalid, outcome_unknown. Unknown exceptions map to a typed `internal_error` with redacted detail; they do not become success.
