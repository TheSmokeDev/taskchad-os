# PRP-E03F-main-web-adapters: Main and Web Turn Adapters

**Status:** draft — requires WF2 review and source-specific hardening
**Primary POL anchors:** POL-PR-002, POL-RT-001, POL-MG-001, POL-MG-003
**Depends on:** E03E

## Goal and context
Migrate main chat and web persona ingress to PersonaTurnService; adapters only normalize/render and preserve compatibility contracts.
...
- **Adapter conformance fixtures compare equivalent operations and event/policy semantics.**
- **Shadow telemetry names divergences before enforcement.**
- **Old turn assembly becomes mechanically unreachable after cutover.**

Stable reasons include: adapter_input_invalid, unsupported_feature, domain_unavailable, render_failed, legacy_path_disabled. Unknown exceptions map to a typed `internal_error` with redacted detail; they do not become success.
