...
**Watch the v0.1.0-alpha.1 demo:** [Desktop shell + Operating Room proof](https://github.com/your-github-user/thehomie-framework/releases/download/v0.1.0-alpha.1/the-homie-v0.1.0-alpha.1-demo.mp4)
