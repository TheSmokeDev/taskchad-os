...
**Logo file**: `.claude/TheHomieLogo.png`
...
**Logo colors:**
- Primary fill: `#3B82F6` (TheHomie Blue)
...
### Primary Accent — TheHomie Blue

The signature brand color. Used for primary actions, links, highlights, and the logo.

| Name | Hex | HSL | Use |
|------|-----|-----|-----|
| TheHomie Blue | `#3B82F6` | 217° 91% 60% | Primary buttons, links, logo |
| TheHomie Dark | `#2563EB` | 217° 91% 53% | Hover states, outlines |
| TheHomie Light | `#60A5FA` | 217° 91% 67% | Secondary accents, highlights |
| TheHomie Pale | `#DBEAFE` | 214° 95% 93% | Light mode backgrounds, fills |

**Rule:** TheHomie Blue is the hero. Use it for actions and emphasis. Don't dilute it by overusing.
...
| Links | TheHomie Blue | `#3B82F6` with hover glow |
...
|------|------------|------|-----|
| Primary | TheHomie Blue | White | Main actions, CTAs |
...
The defining UI pattern for TheHomie. Frosted glass effect over dark backgrounds.
...
:root {
  /* Colors - Primary */
  --thehomie-blue: #3B82F6;
  --thehomie-dark: #2563EB;
  --thehomie-light: #60A5FA;
  --thehomie-pale: #DBEAFE;
...
### TheHomie Blue vs Other Blues

| TheHomie Blue | Other Blues |
|---------------|-------------|
