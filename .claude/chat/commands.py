...
COMMANDS: list[tuple[str, str, str, str]] = [
    ...
    ("provider", "Show runtime provider status — available lanes, health, chain", "router", "admin"),
    ("model", "Switch provider/model - /model claude, sonnet, opus, codex, gemini, auto", "router", "admin"),
